...
export default function SimpleTable() {
  ...
  if (covid19Data.length === 0)
    return (
      <div
        className="loading"
        style={{ padding: 30, fontWeight: 700, color: "violet", fontSize: 50 }}
      >
        Real Time Covid-19 statistics Loading...{" "}
      </div>
    );
    ...
    <>
      ...
      >
        <a
          ...
          href="https://www.facebook.com/SwatontroJote/"
          target="_blank"
        >
          <img
            src={require("../src/images/sjote.jpg")}
            className="logo"
            style={{ width: 50, height: 50 }}
            alt=""
          />
        </a>
        <span className="text-of-corona">করোনা আপডেট বাংলাদেশ</span>
      </span>

      <Stats
        affected={sumOfAffected}
        deaths={sumOfDeaths}
        recovered={sumOfRecovered}
        bdAffected={bdAffected}
        bdDeaths={bdDeaths}
        bdRecovered={bdRecovered}
      />
      <ExpansionPanel>
        ...
        >
          ...
          >
            পূর্ণ উপাত্ত দেখুন (View Full Data)
          </Typography>
        </ExpansionPanelSummary>
      ...
      <p className="symptoms" style={{ fontSize: 35, fontWeight: 500 }}>
        উপসর্গ
      </p>
      <img
        className="images"
      ...
      />
      <p className="spread" style={{ fontSize: 35, fontWeight: 500 }}>
        কিভাবে ছড়ায়
      </p>
      <img
        className="images"
      ...
      />
      <p className="prevention" style={{ fontSize: 35, fontWeight: 500 }}>
        প্রতিরক্ষা
      </p>
      <img
        className="images-435"
        alt="sym0"
      ...
      />
      <p className="sanitization" style={{ fontSize: 35, fontWeight: 500 }}>
        পাশে আসুন, ডাক্তার নার্সদের!
      </p>
      <img
        className="images-700"
        alt="sym0"
        src={require("../src/images/ration.jpg")}
      />
      <p className="icder" style={{ fontSize: 35, fontWeight: 500 }}>
        জরুরি প্রয়োজনে
      </p>
      <img
        className="images"
      ...
      <p className="info" style={{ fontSize: 25, fontWeight: 500 }}>
        *রিয়েল টাইম ডেটা প্রতিনিয়ত আমেরিকার জন হপকিন্স বিশ্ববিদ্যালয় থেকে সংগ্রহ
        করে এখানে উপাত্ত অংশে দেখানো হচ্ছে।
      </p>
    </>
  );
}
